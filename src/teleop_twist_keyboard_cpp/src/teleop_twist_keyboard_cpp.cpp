/**
 * \file teleop_twist_keyboard_cpp.cpp
 * \author Zhihao Zhan (zhanzhihao_dt@163.com)
 * \brief keyboard teleop control
 * \version 0.1
 * \date 2024-01-05
 *
...
std::map<char, std::vector<float>> move_bindings{
    {'i', {1, 0, 0, 0}},  {'o', {1, 0, 0, -1}}, {'j', {0, 0, 0, 1}},   {'l', {0, 0, 0, -1}}, {'u', {1, 0, 0, 1}},
    {',', {-1, 0, 0, 0}}, {'.', {-1, 0, 0, 1}}, {'m', {-1, 0, 0, -1}}, {'O', {1, -1, 0, 0}}, {'I', {1, 0, 0, 0}},
    {'J', {0, 1, 0, 0}},  {'L', {0, -1, 0, 0}}, {'U', {1, 1, 0, 0}},   {'<', {-1, 0, 0, 0}}, {'>', {-1, -1, 0, 0}},
    {'M', {-1, 1, 0, 0}}, {'t', {0, 0, 1, 0}},  {'b', {0, 0, -1, 0}},  {'k', {0, 0, 0, 0}},  {'K', {0, 0, 0, 0}}};

// Map for speed keys
std::map<char, std::vector<float>> speed_bindings{{'q', {1.1, 1.1}}, {'z', {0.9, 0.9}}, {'w', {1.1, 1}},
...
int main(int argc, char **argv)
{
  ...
  while (true)
  {
    ...
    else if (speed_bindings.count(key) == 1)
    {
      // Grab the speed data
